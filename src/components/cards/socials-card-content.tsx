...
const SocialsCardContentComponent = ({ data }: SocialsCardContentProps) => {
  return (
    <div className="flex h-full">
      <div
        className="flex items-center justify-center gap-6 rounded-3xl py-3 pr-6 pl-3 outline outline-foreground1/60"
        style={{
          background:
      ...
      >
        <div className="flex gap-3">
          <a href={data.linkedinUrl} rel="noopener noreferrer" target="_blank">
            <div
              className="flex size-20 items-center justify-center rounded-2xl outline-2 outline-foreground1/80"
              style={{
                background:
        ...
        <div>
          <div
            className="items-top flex h-12 justify-center rounded-full"
            style={{
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(195deg, rgba(152.86, 157.91, 168, 0.50) 0%, rgba(26.62, 27.04, 27.88, 0.50) 100%), linear-gradient(225deg, #5A5B5D 0%, #393A3C 100%)",
